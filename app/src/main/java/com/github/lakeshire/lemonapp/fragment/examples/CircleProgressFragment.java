 ...
 */
public class CircleProgressFragment extends BasePullFragment {
    ...
    public void initUi() {
        ...
        mScrollView = (ScrollView) find(R.id.scrollView);
        mCircleView = (CircleProgressView) find(R.id.circleView);
        mCircleView.setOnProgressChangedListener(new CircleProgressView.OnProgressChangedListener() {
            @Override
            public void onProgressChanged(float value) {
                Logger.d("Progress Changed: " + value);
            }
        });
...
//        mCircleView.setValueAnimated(24); // stops spinning. Spinner spins until on top. Then fills to set value.
        ...
        //Setup Switch
        mSwitchSpin = (Switch) find(R.id.switch1);
        ...
        mSwitchShowUnit = (Switch) find(R.id.switch2);
        ...
        //Setup SeekBar
        mSeekBar = (SeekBar) find(R.id.seekBar);
        ...
        mSeekBarSpinnerLength = (SeekBar) find(R.id.seekBar2);
        ...
        mSpinner = (Spinner) find(R.id.spinner);
